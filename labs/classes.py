...
class Player(object):
    ...
    def talk_to(self, person):
        ...
        if type(person) != str:
            ...
            print(str(person) + ' says: ' + str(self.place.characters[person].message))
            return
        else:
    ...
    def unlock(self, place):
        ...
        if destination_place.locked and not key:
            print(str(destination_place.name) + " can't be unlocked without a key!")
        elif destination_place.locked and key:
            destination_place.locked = False
            print(str(destination_place.name + ' is now unlocked!'))
        else:
            print(str(destination_place.name) + ' is already unlocked!' )
